package me.logjava.army2.fight;

import me.logjava.army2.fight.boss.*;
import me.logjava.army2.fight.bullet.ItemBomHenGio;
import me.logjava.army2.network.Message;
import me.logjava.army2.server.*;
    ...
    public void nextTurn() throws IOException {
        ...
        if (this.bullMNG.addboss.size() > 0) {
            for (byte i = 0; i < this.bullMNG.addboss.size(); i++) {
                BulletManager.AddBoss bos = this.bullMNG.addboss.get(i);
        ...
        if (this.bullMNG.buls.size() > 0) {
            for (byte i = 0; i < this.bullMNG.buls.size(); i++) {
                BulletManager.Bullets bul = this.bullMNG.buls.get(i);
