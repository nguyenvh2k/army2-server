...
import me.logjava.army2.fight.FightManager;
import me.logjava.army2.fight.FightWait;
...
public class User {
    ...
    protected static NVData.EquipmentEntry[][] nvEquipDefault;
    ...
    public void sendMissionInfo() throws IOException {
        ...
        for (int i = 0; i < MissionData.entrys.size(); i++) {
            ...
            MissionData.MissionEntry me = mDatE.entrys.get(missionLevel[i] - 1);
        ...
        try {
            ...
            if (red != null && red.next()) {
                ...
                for (i = 0; i < jarr.size(); i++) {
                    ...
                    // Lay item entry
                    ItemData.ItemEntry itemEntry = ItemData.entrys.get(i);
                    // Gia xu
    ...
    protected void hopTBMessage(Message ms) throws IOException {
        ...
        if (action == 1) {
            ...
            NVData.NVEntry nvE = NVData.entrys.get(this.nv);
...
//                    }
                ...
                case 3:
                    if (hopNgocTB != null) {
                        if (hopNgocTB.slotNull >= this.hopNgocNum) {
                            ...
                            rdE.numb = 1;
                            SpecialItemData.SpecialItemEntry entry = rdE.entry;
            ...
            if (this.hopNgocAction == 1) {
                ...
                if (hopNgocTB != null) {
                    if (hopNgocTB.isUse) {
                        ...
                        for (int i = 0; i < 3; i++) {
                            SpecialItemData.SpecialItemEntry entry = SpecialItemData.getSpecialItemById(hopNgocTB.slot[i]);
    ...
    protected void specialShopMessage(Message ms) throws IOException {
        ...
        if (type == 1) {
            ...
            SpecialItemData.SpecialItemEntry spE = SpecialItemData.getSpecialItemById(idS);
    ...
    public synchronized void updateSpecialItem(int id, int numb) {
        try {
            ...
            SpecialItemData.SpecialItemEntry spE = SpecialItemData.getSpecialItemById(id);
            ArrayList<ruongDoItemEntry> arrayI = new ArrayList<>();
            ruongDoItemEntry rdE = new ruongDoItemEntry();
            rdE.entry = spE;
            rdE.numb = numb;
